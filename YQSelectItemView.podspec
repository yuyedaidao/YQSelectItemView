#
#  Be sure to run `pod spec lint YQSelectItemView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "对付产品经理时不时要弹出页面选择"

  s.homepage     = "https://github.com/yuyedaidao/YQSelectItemView.git"
